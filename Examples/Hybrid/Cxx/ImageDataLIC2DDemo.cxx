...
// * Example demonstrating use of vtkKWEImageDataLIC2D filter.
// * Typical usage:
//    ./bin/ImageDataLIC2DDemo --data=<vtk file> --output=<png file>
int ImageDataLIC2DDemo(int argc, char* argv[])
{
  ...
  CREATE_NEW(filter, vtkKWEImageDataLIC2D);
...
{
  return ImageDataLIC2DDemo(argc, argv);
}
#endif
