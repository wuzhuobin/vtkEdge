...
vtkStandardNewMacro(vtkKWEDataTransferHelper);
vtkCxxRevisionMacro(vtkKWEDataTransferHelper, "$Revision: 808 $");
vtkCxxSetObjectMacro(vtkKWEDataTransferHelper, Texture, vtkTextureObject);
vtkCxxSetObjectMacro(vtkKWEDataTransferHelper, Array, vtkDataArray);
//----------------------------------------------------------------------------
vtkKWEDataTransferHelper::vtkKWEDataTransferHelper()
{
  this->Texture = 0;
  this->Context = 0;
  this->Array = 0;
...
bool vtkKWEDataTransferHelper::GetExtentIsValid(int *extent)
{
...
bool vtkKWEDataTransferHelper::GetCPUExtentIsValid()
{
...
bool vtkKWEDataTransferHelper::GetGPUExtentIsValid()
{
...
bool vtkKWEDataTransferHelper::GetTextureExtentIsValid()
{
...
bool vtkKWEDataTransferHelper::IsSupported(vtkRenderWindow* renWin)
{
...
//----------------------------------------------------------------------------
bool vtkKWEDataTransferHelper::LoadRequiredExtensions(
...
//----------------------------------------------------------------------------
vtkRenderWindow* vtkKWEDataTransferHelper::GetContext()
{
  return this->Context;
}

//----------------------------------------------------------------------------
void vtkKWEDataTransferHelper::SetContext(vtkRenderWindow* renWin)
{
...
bool vtkKWEDataTransferHelper::Upload(int components,
                                      int *componentList)
{
  ...
  //cout <<"CPUDims: " << cpudims[0] << ", " << cpudims[1] << ", " << cpudims[2] << endl;
  //cout <<"GPUDims: " << gpudims[0] << ", " << gpudims[1] << ", " << gpudims[2] << endl;
...
bool vtkKWEDataTransferHelper::Download()
{
  return (this->DownloadAsync1() && this->DownloadAsync2());
}

//----------------------------------------------------------------------------
bool vtkKWEDataTransferHelper::DownloadAsync1()
{
  if (!this->Context)
    {
...
//----------------------------------------------------------------------------
bool vtkKWEDataTransferHelper::DownloadAsync2()
{
...
//----------------------------------------------------------------------------
bool vtkKWEDataTransferHelper::GetShaderSupportsTextureInt()
{
  return this->ShaderSupportsTextureInt;
}

//----------------------------------------------------------------------------
void vtkKWEDataTransferHelper::SetShaderSupportsTextureInt(bool value)
{
  this->ShaderSupportsTextureInt = value;
}

//----------------------------------------------------------------------------
vtkPixelBufferObject* vtkKWEDataTransferHelper::GetPBO()
{
...
//----------------------------------------------------------------------------
void vtkKWEDataTransferHelper::PrintSelf(ostream& os, vtkIndent indent)
{
