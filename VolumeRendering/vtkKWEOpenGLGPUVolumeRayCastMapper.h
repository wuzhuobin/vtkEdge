...
//-----------------------------------------------------------------------------
// .NAME vtkKWEOpenGLGPUVolumeRayCastMapper - OpenGL subclass that draws the 
// image to the screen
// .SECTION Description
...
#ifndef __vtkKWEOpenGLGPUVolumeRayCastMapper_h
#define __vtkKWEOpenGLGPUVolumeRayCastMapper_h
...
class vtkPolyData;
class vtkKWEClipConvexPolyData;
class vtkClipPolyData;
class vtkKWETessellatedBoxSource;

class vtkKWEOpacityTable; // internal class.
class vtkKWScalarField; // internal class.

class vtkKWEOpacityTables; // Pimpl
class vtkKWEDensifyPolyData;
class vtkStdString;

class VTKEdge_VOLUMERENDERING_EXPORT vtkKWEOpenGLGPUVolumeRayCastMapper : public vtkKWEGPUVolumeRayCastMapper
{
public:
  static vtkKWEOpenGLGPUVolumeRayCastMapper *New();
  vtkTypeRevisionMacro(vtkKWEOpenGLGPUVolumeRayCastMapper,vtkKWEGPUVolumeRayCastMapper);
...
protected:
  ...
  // \pre valid_raycastMethod: raycastMethod>= vtkOpenGLGPUVolumeRayCastMapperMethodMaximumIntensityProjection && raycastMethod<=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIPFourDependent
  ...
  vtkKWEClipConvexPolyData *Clip;
  vtkMatrix4x4 *InvVolumeMatrix;
  
  vtkKWEDensifyPolyData *Densify;
  ...
  int LastSize[2];
  bool DataBufferInitialized;
  bool ColorTableInitialized;
  bool LastColorTransferFunctionLinearInterpolation;
  ...
  vtkTimeStamp ColorTransferFunctionBuildTime;
...
//  int FragmentCodeCapacity;
  ...
  vtkKWETessellatedBoxSource *BoxSource;
  ...
  vtkKWEOpacityTables *OpacityTables;
...
private:
  vtkKWEOpenGLGPUVolumeRayCastMapper(const vtkKWEOpenGLGPUVolumeRayCastMapper&);  // Not implemented.
  void operator=(const vtkKWEOpenGLGPUVolumeRayCastMapper&);  // Not implemented.
};
