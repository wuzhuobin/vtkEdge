...
#include "vtkKWEDensifyPolyData.h"
...
extern const char *vtkKWEGPUVolumeRayCastMapper_CompositeFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_CompositeFourDependentFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_CompositeShadeFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_CompositeCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_CompositeNoCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_HeaderFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MIPFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MIPFourDependentFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MIPFourDependentCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MIPFourDependentNoCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MIPCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MIPNoCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_ParallelProjectionFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_PerspectiveProjectionFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_ScaleBiasFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MinIPFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MinIPFourDependentFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MinIPFourDependentCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MinIPFourDependentNoCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MinIPCroppingFS;
extern const char *vtkKWEGPUVolumeRayCastMapper_MinIPNoCroppingFS;

enum
{
  vtkKWEOpenGLGPUVolumeRayCastMapperProjectionNotInitialized=-1, // not init
  vtkKWEOpenGLGPUVolumeRayCastMapperProjectionPerspective=0, // false
  vtkKWEOpenGLGPUVolumeRayCastMapperProjectionParallel=1 // true
};

enum
{
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodNotInitialized,
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIP,
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIPFourDependent,
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodComposite,
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodCompositeShade,
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodCompositeFourDependent,
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIP,
  vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIPFourDependent
};
...
enum
{
  vtkKWEOpenGLGPUVolumeRayCastMapperCroppingNotInitialized,
  vtkKWEOpenGLGPUVolumeRayCastMapperCompositeCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperCompositeNoCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMIPCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMIPNoCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMIPFourDependentCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMIPFourDependentNoCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMinIPCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMinIPNoCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMinIPFourDependentCropping,
  vtkKWEOpenGLGPUVolumeRayCastMapperMinIPFourDependentNoCropping
};

enum
{
//  vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectDataSet=0, // 3d texture
  vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectColorMap=0, // 1d texture
//  vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectOpacityMap, // 1d texture
  vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectDepthMap, // 2d texture
  vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront // 2d texture
};

const int vtkKWEOpenGLGPUVolumeRayCastMapperNumberOfTextureObjects=vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+2;

const int vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize=1024; //power of two

#ifndef VTK_IMPLEMENT_MESA_CXX
vtkCxxRevisionMacro(vtkKWEOpenGLGPUVolumeRayCastMapper, "$Revision: 812 $");
vtkStandardNewMacro(vtkKWEOpenGLGPUVolumeRayCastMapper);
#endif

//-----------------------------------------------------------------------------
//
//-----------------------------------------------------------------------------
class vtkKWEOpacityTable
{
public:
  vtkKWEOpacityTable()
    {
              ...
              bool linearInterpolation)
    {
      ...
      if(scalarOpacity->GetMTime() > this->BuildTime ||
        ...
        if(this->Table==0)
          {
          this->Table=
            new float[vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize];
          }
        
        scalarOpacity->GetTable(range[0],range[1],
                                vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize,
                                this->Table);
        ...
        if(blendMode==vtkVolumeMapper::COMPOSITE_BLEND)
          ...
          int i=0;
          while(i<vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize)
            {
            if(*ptr>0.0001f)
              {
        ...
        glTexImage1D(GL_TEXTURE_1D,0,GL_ALPHA16,
                     vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize,0,
                     GL_ALPHA,GL_FLOAT,this->Table);
        vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError("1d opacity texture is too large");
        this->Loaded=true;
...
//
//-----------------------------------------------------------------------------
class vtkKWEOpacityTables
{
public:
  vtkstd::vector<vtkKWEOpacityTable> Vector;
  vtkKWEOpacityTables(size_t numberOfLevels)
    : Vector(numberOfLevels)
    {
    }
private:
  // undefined copy constructor.
  vtkKWEOpacityTables(const vtkKWEOpacityTables &other);
  // undefined assignment operator.
  vtkKWEOpacityTables &operator=(const vtkKWEOpacityTables &other);
};
          ...
          if(this->Loaded)
            ...
            if(this->Loaded)
              ...
              if(errorCode!=GL_NO_ERROR)
                ...
                cout<<vtkKWEOpenGLGPUVolumeRayCastMapper::OpenGLErrorMessage(static_cast<unsigned int>(errorCode));
                cout<<endl;
                }
              ...
              if(this->Loaded)
                ...
                if(needTypeConversion)
                  ...
                  if(1) // !this->SupportsPixelBufferObjects)
                    ...
                    vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError("genbuffer");
                    vtkgl::BindBuffer(vtkgl::PIXEL_UNPACK_BUFFER,pbo);
                    vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError("binbuffer");
                    ...
                    vtkgl::BufferData(vtkgl::PIXEL_UNPACK_BUFFER,texSize,dataPtr,
                                      vtkgl::STREAM_DRAW);
                    vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError("bufferdata");
                    vtkgl::TexImage3D(vtkgl::TEXTURE_3D, 0, internalFormat,
                                      textureSize[0],textureSize[1],textureSize[2],
                                      0,format,type,0);
                    vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError("teximage3d");
                    vtkgl::BindBuffer(vtkgl::PIXEL_UNPACK_BUFFER,0);
                    vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError("bindbuffer to 0");
                    vtkgl::DeleteBuffers(1,&pbo);
                    }
                  vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError("3d texture is too large2");
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::CheckFrameBufferStatus()
{
//  cout<<"--------------------"<<endl;
  GLenum status;
...
//-----------------------------------------------------------------------------
vtkStdString vtkKWEOpenGLGPUVolumeRayCastMapper::BufferToString(int buffer)
{
  vtkStdString result;
...
// ----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::DisplayReadAndDrawBuffers()
{
  GLint value;
...
//
// ----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::DisplayFrameBufferAttachments()
{
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::DisplayFrameBufferAttachment(
...
// not be null.
//-----------------------------------------------------------------------------
const char *vtkKWEOpenGLGPUVolumeRayCastMapper::OpenGLErrorMessage(
...
// message if any.
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::PrintError(const char *headerMessage)
{
  GLenum errorCode=glGetError();
  if(errorCode!=GL_NO_ERROR)
    {
...
//-----------------------------------------------------------------------------
// Construct a new vtkKWEOpenGLGPUVolumeRayCastMapper with default values
//-----------------------------------------------------------------------------
vtkKWEOpenGLGPUVolumeRayCastMapper::vtkKWEOpenGLGPUVolumeRayCastMapper()
{
  ...
  int i=0;
  while(i<vtkKWEOpenGLGPUVolumeRayCastMapperNumberOfTextureObjects)
    {
  ...
  this->LastSize[0]=0;
  this->LastSize[1]=0;
  this->DataBufferInitialized=false;
  this->ColorTableInitialized=false;
  this->LastColorTransferFunctionLinearInterpolation=false;
  ...
  this->LastParallelProjection=
    vtkKWEOpenGLGPUVolumeRayCastMapperProjectionNotInitialized;
...
//-----------------------------------------------------------------------------
// Destruct a vtkKWEOpenGLGPUVolumeRayCastMapper - clean up any memory used
//-----------------------------------------------------------------------------
vtkKWEOpenGLGPUVolumeRayCastMapper::~vtkKWEOpenGLGPUVolumeRayCastMapper()
{
...
//
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::IsRenderSupported(
...
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::TestRequiredExtension(
...
//     any failure codes
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::LoadExtensions(
  vtkRenderWindow *window)
{ 
...
//sscanf(version, "%d.%d", &glslMajor, &glslMinor);
  ...
  this->BuildProgram(1,vtkKWEOpenGLGPUVolumeRayCastMapperMethodComposite);
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::CreateGLSLObjects()
{
  ...
  vtkgl::ShaderSource(
    ...
    const_cast<const char **>(&vtkKWEGPUVolumeRayCastMapper_HeaderFS),0);
...
// will be 1.
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::CreateOpenGLObjects()
{
  ...
  GLuint textureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperNumberOfTextureObjects];
  ...
  int i=0;
  while(i<( vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+this->NumberOfFrameBuffers))
    {
    textureObjects[i]=0;
    ++i;
    }
  ...
  glGenTextures(vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+this->NumberOfFrameBuffers,textureObjects);
  // Color buffers
  GLint value;
  ...
  while(i<this->NumberOfFrameBuffers)
    {
    glBindTexture(GL_TEXTURE_2D,textureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+i]);
    ++i;
    }
  vtkgl::FramebufferTexture2DEXT(vtkgl::FRAMEBUFFER_EXT,
                                 vtkgl::COLOR_ATTACHMENT0_EXT,GL_TEXTURE_2D,
                                 textureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront],
                                 0);
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::CheckCompilation(
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::PrintUniformVariables(unsigned int programShader)
{
  GLint params;
...
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::CheckLinkage(unsigned int programShader)
{
  GLint params;
  GLuint prog=static_cast<GLuint>(programShader);
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::ReleaseGraphicsResources(
  vtkWindow *window)
{
  if(this->OpenGLObjectsCreated)
    {
    ...
    glDeleteTextures(vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+this->NumberOfFrameBuffers,textureObjects);
...
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::AllocateFrameBuffers(vtkRenderer *ren)
{
  ...
  if(sizeChanged)
    ...
    while(i <this->NumberOfFrameBuffers && errorCode==GL_NO_ERROR)
      {
      glBindTexture(GL_TEXTURE_2D,static_cast<GLuint>(this->TextureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+i]));
    ...
    if(errorCode==GL_NO_ERROR)
      ...
      glBindTexture(GL_TEXTURE_2D,static_cast<GLuint>(this->TextureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectDepthMap]));
  ...
  int needNewMaxValueBuffer=this->MaxValueFrameBuffer==0 &&
    (this->BlendMode==vtkVolumeMapper::MAXIMUM_INTENSITY_BLEND ||
     this->BlendMode==vtkKWEGPUVolumeRayCastMapper::MINIMUM_INTENSITY_BLEND);
  ...
  if((this->BlendMode==vtkVolumeMapper::MAXIMUM_INTENSITY_BLEND
      || this->BlendMode==vtkKWEGPUVolumeRayCastMapper::MINIMUM_INTENSITY_BLEND) && (sizeChanged || needNewMaxValueBuffer))
    {
    // max scalar frame buffer
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::GetTextureFormat(
  vtkImageData *input,
...
//-----------------------------------------------------------------------------
bool vtkKWEOpenGLGPUVolumeRayCastMapper::TestLoadingScalar(
  unsigned int internalFormat,
  unsigned int format,
  unsigned int type,
  int textureSize[3],
...
//                           textureExtent[4]<=textureExtent[5])))
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::LoadScalarField(vtkImageData *input,
                                                       int textureExtent[6],
                                                       vtkVolume *volume)
{
...
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::UpdateColorTransferFunction(
  vtkVolume *vol,
  int numberOfScalarComponents)
{
  ...
  if(numberOfScalarComponents==1)
    ...
    vtkColorTransferFunction *colorTransferFunction=volumeProperty->GetRGBTransferFunction();
    bool needUpdate=
      colorTransferFunction->GetMTime()>this->ColorTransferFunctionBuildTime
      || !this->ColorTableInitialized;
    
    bool linear=
      volumeProperty->GetInterpolationType()==VTK_LINEAR_INTERPOLATION;
    
    bool needInterpolationUpdate=needUpdate ||
      linear!=this->LastColorTransferFunctionLinearInterpolation;
    
    if(needInterpolationUpdate)
      {
      vtkgl::ActiveTexture( vtkgl::TEXTURE1 );
      glBindTexture(GL_TEXTURE_1D,static_cast<GLuint>(this->TextureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectColorMap]));
      }
    
    if(needUpdate)
      {
      float *colorTable=new float[vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize*3]; // 3 components: RGB
      colorTransferFunction->GetTable(
        this->TableRange[0],this->TableRange[1],
        vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize,colorTable);
      glTexParameteri(GL_TEXTURE_1D, GL_TEXTURE_WRAP_S, vtkgl::CLAMP_TO_EDGE);
      
      glTexImage1D(GL_TEXTURE_1D,0,GL_RGB16,
                   vtkKWEOpenGLGPUVolumeRayCastMapperOpacityTableSize,0,GL_RGB,
                   GL_FLOAT,colorTable);
      this->PrintError("1d color texture is too large");
      delete[] colorTable;
      this->ColorTableInitialized=true;
      this->ColorTransferFunctionBuildTime.Modified();
      }
    
    if(needInterpolationUpdate)
      {
      GLint value;
      this->LastColorTransferFunctionLinearInterpolation=linear;
      if(linear)
        {
        value=GL_LINEAR;
        }
...
// \pre valid_numberOfScalarComponents: numberOfScalarComponents==1 || numberOfScalarComponents==4
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::UpdateOpacityTransferFunction(
  vtkVolume *vol,
  int numberOfScalarComponents,
  unsigned int level)
{
...
// \pre vol_exists: vol!=0
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::SetupRender(vtkRenderer *ren,
                                                    vtkVolume *vol)
{
  assert("pre: ren_exists" && ren!=0);
  assert("pre: vol_exists" && vol!=0);
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::DebugDisplayBox(vtkPolyData *box)
{
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::ClipBoundingBox(vtkRenderer *ren,
                                                        double worldBounds[6],
                                                        vtkVolume *vol)
{
  if(this->BoxSource==0)
    {
    this->BoxSource=vtkKWETessellatedBoxSource::New();
    }
  ...
  if(this->Clip==0)
    {
    this->Clip=vtkKWEClipConvexPolyData::New();
  ...
  if(this->Densify==0)
    {
    this->Densify=vtkKWEDensifyPolyData::New();
...
//
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::RenderClippedBoundingBox(
  int tcoordFlag,
  size_t currentBlock,
  ...
  vtkRenderWindow *renWin )
{
  ...
  glBindTexture(GL_TEXTURE_2D,
                this->TextureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+1]);
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::CleanupRender()
{
  glPopMatrix();
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::BuildScaleBiasProgram()
{
  if(this->ScaleBiasProgramShader==0)
    ...
    vtkgl::ShaderSource(
      fragmentShader,1,
      const_cast<const char **>(&vtkKWEGPUVolumeRayCastMapper_ScaleBiasFS),0);
...
// \pre ren_exists: ren!=0
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::RenderTextureToScreen(vtkRenderer *ren)
{
  assert("pre: ren_exists" && ren!=0);
  ...
  if ( this->GeneratingCanonicalView )
    ...
    glBindTexture(GL_TEXTURE_2D, 
                  this->TextureObjects[
                    vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront]);
  ...
  glBindTexture(GL_TEXTURE_2D, 
                this->TextureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront]);
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::ComputeReductionFactor(
...
//   - numberOfLevels >= 1
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::PreRender(vtkRenderer *ren,
                                                  vtkVolume *vol,
                                                  ...
                                                  unsigned int numberOfLevels)
{
  ...
  switch(this->BlendMode)
    ...
    case vtkVolumeMapper::COMPOSITE_BLEND:
      if ( vol->GetProperty()->GetShade() )
        ...
        rayCastMethod=vtkKWEOpenGLGPUVolumeRayCastMapperMethodCompositeShade;
        ...
        if(numberOfScalarComponents==1)
          {
          rayCastMethod=vtkKWEOpenGLGPUVolumeRayCastMapperMethodComposite;
          }
        else
          {
          rayCastMethod=
    ...
    case vtkVolumeMapper::MAXIMUM_INTENSITY_BLEND:
      //cout<<"program is MIP"<<endl;
      if(numberOfScalarComponents==1)
        {
        rayCastMethod=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIP;
        }
      else
        {
        rayCastMethod=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIPFourDependent;
        }
      break;
    case vtkKWEGPUVolumeRayCastMapper::MINIMUM_INTENSITY_BLEND:
      //cout<<"program is MinIP"<<endl;
      if(numberOfScalarComponents==1)
        {
        rayCastMethod=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIP;
        }
      else
        {
        rayCastMethod=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIPFourDependent;
        }
      break;
    default:
      assert("check: impossible case" && 0);
  ...
  this->BuildProgram(parallelProjection,rayCastMethod);
  ...
  if(this->NumberOfCroppingRegions>1)
    {
    // framebuffer texture
    if(rayCastMethod!=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIP && rayCastMethod!=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIP)
      {
      vtkgl::ActiveTexture( vtkgl::TEXTURE4 );
      glBindTexture(GL_TEXTURE_2D,static_cast<GLuint>(this->TextureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront]));
...
//  cout << "check after color init" << endl;
  ...
  if(this->NumberOfCroppingRegions>1 &&
     (this->BlendMode==vtkKWEGPUVolumeRayCastMapper::MINIMUM_INTENSITY_BLEND
      || this->BlendMode==vtkKWEGPUVolumeRayCastMapper::MAXIMUM_INTENSITY_BLEND))
    {
...
//    cout << "this->MaxValueFrameBuffer2="<< this->MaxValueFrameBuffer2 <<endl;
    ...
    if(this->BlendMode==vtkKWEGPUVolumeRayCastMapper::MINIMUM_INTENSITY_BLEND)
      {
...
//    cout << "check before clear on max" << endl;
  ...
  if(this->NumberOfCroppingRegions>1)
    ...
    vtkgl::ActiveTexture(vtkgl::TEXTURE4);
    glBindTexture(GL_TEXTURE_2D,this->TextureObjects[vtkKWEOpenGLGPUVolumeRayCastMapperTextureObjectFrameBufferLeftFront+1]);
  ...
  if(this->OpacityTables==0)
    {
    this->OpacityTables=new vtkKWEOpacityTables(numberOfLevels);
    }
...
//-----------------------------------------------------------------------------
double vtkKWEOpenGLGPUVolumeRayCastMapper::ComputeMinimalSampleDistancePerPixel(
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::RenderBlock(vtkRenderer *ren,
                                                    vtkVolume *vol,
                                                    unsigned int level)
{
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::PostRender(
  vtkRenderer *ren,
  int numberOfScalarComponents)
{
  ...
  if(this->NumberOfCroppingRegions>1)
    ...
    if(this->LastRayCastMethod!=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIP
      && this->LastRayCastMethod!=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIP)
      {
      vtkgl::ActiveTexture( vtkgl::TEXTURE4 );
      glBindTexture(GL_TEXTURE_2D,0);
      }
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::GPURender(vtkRenderer *ren,
                                                  vtkVolume *vol)
{  
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::RenderWholeVolume(vtkRenderer *ren,
                                                          vtkVolume *vol)
{
  double volBounds[6];
  this->GetInput()->GetBounds(volBounds);
...
//
//-----------------------------------------------------------------------------
int vtkRegionComparisonFunction(const void *x,
                                const void *y)
{
...
// \pre this->ProgramShader!=0 and is linked.
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::RenderRegions(vtkRenderer *ren,
                                                      vtkVolume *vol)
{
  double bounds[27][6];
  double distance2[27];
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::ComputeNumberOfCroppingRegions()
{
  this->NumberOfCroppingRegions=0;
  if(this->Cropping)
    {
...
// corresponding axis.
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::SlabsFromDatasetToIndex(
...
// corresponding axis.
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::SlabsFromIndexToDataset(
  double slabsPoints[6],
  double slabsDataSet[6])
{
  double *spacing=this->GetInput()->GetSpacing();
...
// \pre this->ProgramShader!=0 and is linked.
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::RenderSubVolume(vtkRenderer *ren,
                                                       double bounds[6],
                                                       vtkVolume *volume)
{
...
//      if(subvolumeTextureExtent[i]<realExtent[i])
//        {
//        ++subvolumeTextureExtent[i];
//        }
      ++i;
      }
    }
  ...
  int loaded=texture!=0 && texture->IsLoaded() && this->GetInput()->GetMTime()<=texture->GetBuildTime() && texture->GetLoadedCellFlag()==this->CellFlag;
  ...
  if(!loaded)
    ...
    if(!this->LoadScalarField(this->GetInput(),wholeTextureExtent,volume))
      {
//      cout<<"Too large to load the all dataset"<<endl;
      // 4. loading the whole dataset failed: try to load the subvolume
      if(!this->LoadScalarField(this->GetInput(),subvolumeTextureExtent,
                                volume))
        {
        // 5. loading the subvolume failed: stream the subvolume
//        cout<<"Too large to load the all subvolume: STREAMING"<<endl;
        ...
        while(!abort && i < count) // 1) //count)
          ...
          // Load the block
          if(!this->LoadScalarField(this->GetInput(),blockTextureExtent,
                                    volume))
            {
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::LoadProjectionParameters(
  vtkRenderer *ren,
  vtkVolume *vol)
{
  vtkMatrix4x4 *worldToDataset=vol->GetMatrix();
  ...
  int rayCastMethod=this->LastRayCastMethod; // NEW
  
  if(rayCastMethod==vtkKWEOpenGLGPUVolumeRayCastMapperMethodCompositeShade)
    {
    index=0;
    column=0;
    while(column<3)
...
//    raycastMethod<=vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIPFourDependent
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::BuildProgram(int parallelProjection,
                                                     int raycastMethod)
{
...
//  cout<<"method="<<raycastMethod<<endl; 
  if(parallelProjection!=this->LastParallelProjection)
    ...
    if(parallelProjection)
      {
      projectionCode=vtkKWEGPUVolumeRayCastMapper_ParallelProjectionFS;
      }
    else
      {
      projectionCode=vtkKWEGPUVolumeRayCastMapper_PerspectiveProjectionFS;
      }
  ...
  if(raycastMethod!=this->LastRayCastMethod)
    ...
    switch(raycastMethod)
      {
      case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIP:
        methodCode=vtkKWEGPUVolumeRayCastMapper_MIPFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMethodComposite:
        methodCode=vtkKWEGPUVolumeRayCastMapper_CompositeFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMethodCompositeShade:
        methodCode=vtkKWEGPUVolumeRayCastMapper_CompositeShadeFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMethodCompositeFourDependent:
        methodCode=vtkKWEGPUVolumeRayCastMapper_CompositeFourDependentFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIPFourDependent:
        methodCode=vtkKWEGPUVolumeRayCastMapper_MIPFourDependentFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIP:
        methodCode=vtkKWEGPUVolumeRayCastMapper_MinIPFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIPFourDependent:
        methodCode=vtkKWEGPUVolumeRayCastMapper_MinIPFourDependentFS;
        break;
      }
  ...
  switch(raycastMethod)
    ...
    case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIP:
      if(this->NumberOfCroppingRegions>1)
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperMIPCropping;
        }
      else
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperMIPNoCropping;
        }
      break;
    case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMIPFourDependent:
      if(this->NumberOfCroppingRegions>1)
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperMIPFourDependentCropping;
        }
      else
        {
        croppingMode=
    ...
    case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIP:
      if(this->NumberOfCroppingRegions>1)
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperMinIPCropping;
        }
      else
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperMinIPNoCropping;
        }
      break;
    case vtkKWEOpenGLGPUVolumeRayCastMapperMethodMinIPFourDependent:
      if(this->NumberOfCroppingRegions>1)
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperMinIPFourDependentCropping;
        }
      else
        {
        croppingMode=
    ...
    default:
      if(this->NumberOfCroppingRegions>1)
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperCompositeCropping;
        }
      else
        {
        croppingMode=vtkKWEOpenGLGPUVolumeRayCastMapperCompositeNoCropping;
        }
      break;
    }
...
//  cout<<"croppingMode="<<croppingMode<<endl;
  if(croppingMode!=this->LastCroppingMode)
    ...
    switch(croppingMode)
      {
      case vtkKWEOpenGLGPUVolumeRayCastMapperMIPCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MIPCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMIPNoCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MIPNoCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMIPFourDependentCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MIPFourDependentCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMIPFourDependentNoCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MIPFourDependentNoCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperCompositeCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_CompositeCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperCompositeNoCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_CompositeNoCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMinIPCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MinIPCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMinIPNoCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MinIPNoCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMinIPFourDependentCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MinIPFourDependentCroppingFS;
        break;
      case vtkKWEOpenGLGPUVolumeRayCastMapperMinIPFourDependentNoCropping:
        croppingCode=vtkKWEGPUVolumeRayCastMapper_MinIPFourDependentNoCroppingFS;
        break; 
      }
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::ValidateProgram()
{
...
//
//-----------------------------------------------------------------------------
const char *vtkKWEOpenGLGPUVolumeRayCastMapper::GetEnabledString(
  unsigned char value)
{
  if(value)
    {
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::GetOpenGLState()
{
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::GetLightingStatus()
{
  //cout<<"lighting: ";
...
//-----------------------------------------------------------------------------
int vtkKWEOpenGLGPUVolumeRayCastMapper::PowerOfTwoGreaterOrEqual(int x)
{
...
//
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::UpdateNoiseTexture()
{
  if(this->NoiseTextureId==0)
    {
...
//    const float factor=1.0f;
    ...
    if(this->NoiseTexture==0)
      ...
      while(j<size)
        ...
        while(i<size)
          {
          this->NoiseTexture[j*size+i]=amplitude+static_cast<float>(noiseGenerator->EvaluateFunction(i,j,0.0));
          ++i;
          }
        ++j;
        }
...
void vtkKWEOpenGLGPUVolumeRayCastMapper::GetReductionRatio(double ratio[3])
{  
...
//-----------------------------------------------------------------------------
void vtkKWEOpenGLGPUVolumeRayCastMapper::PrintSelf(ostream& os,
                                                  vtkIndent indent)
{
