...
vtkCxxRevisionMacro(vtkKWEGPUVolumeRayCastMapper, "$Revision: 673 $");
vtkInstantiatorNewMacro(vtkKWEGPUVolumeRayCastMapper);

vtkKWEGPUVolumeRayCastMapper::vtkKWEGPUVolumeRayCastMapper()
{
...
// ----------------------------------------------------------------------------
vtkKWEGPUVolumeRayCastMapper *vtkKWEGPUVolumeRayCastMapper::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = 
    vtkKWEVolumeRenderingFactory::CreateInstance("vtkKWEGPUVolumeRayCastMapper");
  return static_cast<vtkKWEGPUVolumeRayCastMapper*>(ret);
}
...
//   - Invoke an end event
// ----------------------------------------------------------------------------
void vtkKWEGPUVolumeRayCastMapper::Render( vtkRenderer *ren, vtkVolume *vol )
{
...
// ----------------------------------------------------------------------------
void vtkKWEGPUVolumeRayCastMapper::CanonicalViewRender( vtkRenderer *ren, vtkVolume *vol )
{
  // Make sure everything about this render is OK
  if ( this->ValidateRender(ren, vol ) )
    {
...
// ----------------------------------------------------------------------------
int vtkKWEGPUVolumeRayCastMapper::ValidateRender( vtkRenderer *ren,
                                                  vtkVolume *vol )
{
...
// cell data (1).
void vtkKWEGPUVolumeRayCastMapper::SetCellFlag(int cellFlag)
{
  this->CellFlag=cellFlag;
}

// ----------------------------------------------------------------------------
void vtkKWEGPUVolumeRayCastMapper::CreateCanonicalView(
  vtkRenderer *ren,
  vtkVolume *volume,
  vtkImageData *image,
...
// ----------------------------------------------------------------------------
// Print method for vtkKWEGPUVolumeRayCastMapper
void vtkKWEGPUVolumeRayCastMapper::PrintSelf(ostream& os, vtkIndent indent)
{
...
//             this->CroppingRegionPlanes[2]<this->CroppingRegionPlanes[3] &&
//             this->CroppingRegionPlanes[4]<this->CroppingRegionPlanes[5])
void vtkKWEGPUVolumeRayCastMapper::ClipCroppingRegionPlanes()
{
