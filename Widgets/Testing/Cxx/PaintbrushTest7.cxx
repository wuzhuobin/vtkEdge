...
//=============================================================================
//
// Uses a box as the paintbrush shape.
...
int PaintbrushTest7( int argc, char *argv[] )
{
  if( argc < 6 )
    {
  ...
  cout << "Reading : " << paintbrushTesting->GetFilename() << endl;
  paintbrushTesting->FourPaneViewOff();
  cout << "Does paintbrush testing have four pane view ? " << paintbrushTesting->GetFourPaneView() << endl;
  ...
  for (int i = 0; i < 3; i++)
    ...
    if (rep)
      ...
      // Set a cuboid as the paintbrush shape instead of the default ellipsoid
